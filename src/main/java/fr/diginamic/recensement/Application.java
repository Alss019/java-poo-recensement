...
import fr.diginamic.recensement.services.IllegalChart;
...
public class Application {
	 ...
	 * @throws IllegalChart 
	 */
	public static void main(String[] args) throws IllegalChart {
		...
		do {
			...
			case 4:
				try {
				    // Appel à RecherchePopulationBorneService
